...
func (impl *clusterImpl) GetCluster(ctx context.Context, clusterID ID, opts *ResourceGetOptions) (*Cluster, error) {
	...
	if err := impl.client.sendGetRequest(ctx, uri, "", jsonPayloadDecodeFactory(&cluster), appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID))); err != nil {
		return nil, err
	}
	return &cluster, nil
}
...
func (impl *clusterImpl) UpdateClusterSettings(ctx context.Context, clusterID ID, settings *ClusterSettings, opts *ResourceUpdateOptions) error {
	...
	if err := impl.client.sendPatchRequest(ctx, uri, "", settings, nil, appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID))); err != nil {
		return err
	}
	return nil
}
...
func (impl *clusterImpl) UpdateClusterPlugins(ctx context.Context, clusterID ID, plugins Plugins, opts *ResourceUpdateOptions) error {
	...
	if err := impl.client.sendPatchRequest(ctx, uri, "", plugins, nil, appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID))); err != nil {
		return err
	}
	return nil
}
...
func (impl *clusterImpl) GenerateGatewaySideCertificate(ctx context.Context, clusterID ID, _ *ResourceCreateOptions) (*TLSBundle, error) {
	...
	err := impl.client.sendGetRequest(ctx, uri, "", jsonPayloadDecodeFactory(&bundle), appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID)))
	if err != nil {
		return nil, err
	}
	return &bundle, nil
...
func (impl *clusterImpl) GetGatewayInstanceStartupConfigTemplate(ctx context.Context, clusterID ID, configType string, _ *ResourceGetOptions) (string, error) {
	...
	err := impl.client.sendGetRequest(ctx, uri, "", jsonPayloadDecodeFactory(&configPayload), appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID)))
	if err != nil {
		return "", err
	}
...
func (impl *clusterImpl) ListAllGatewayInstances(ctx context.Context, clusterID ID, _ *ResourceListOptions) ([]GatewayInstance, error) {
	...
	err := impl.client.sendGetRequest(ctx, uri, "", jsonPayloadDecodeFactory(&lr), appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID)))
	if err != nil {
		return nil, err
	}
...
func (impl *clusterImpl) listAllLabels(ctx context.Context, clusterID ID, resource string) ([]string, error) {
	...
	err := impl.client.sendGetRequest(ctx, uri, "", jsonPayloadDecodeFactory(&labels), appendHeader(mapClusterIdFromHttpClient(impl.client), mapClusterId(clusterID)))
	if err != nil {
		return nil, err
	}
	return labels, nil
