...
func (impl *serviceRegistryImpl) CreateServiceRegistry(ctx context.Context, registry *ServiceRegistry, opts *ResourceCreateOptions) (*ServiceRegistry, error) {
	...
	err := impl.client.sendPostRequest(ctx, uri, "", registry, jsonPayloadDecodeFactory(&createdRegistry), appendHeader(mapClusterIdFromOpts(opts)))
	if err != nil {
		return nil, err
	}
...
func (impl *serviceRegistryImpl) UpdateServiceRegistry(ctx context.Context, registry *ServiceRegistry, opts *ResourceUpdateOptions) (*ServiceRegistry, error) {
	...
	err := impl.client.sendPutRequest(ctx, uri, "", registry, jsonPayloadDecodeFactory(&updatedRegistry), appendHeader(mapClusterIdFromOpts(opts)))
	if err != nil {
		return nil, err
	}
...
func (impl *serviceRegistryImpl) GetServiceRegistry(ctx context.Context, registryID ID, opts *ResourceGetOptions) (*ServiceRegistry, error) {
	...
	err := impl.client.sendGetRequest(ctx, uri, "", jsonPayloadDecodeFactory(&registry), appendHeader(mapClusterIdFromOpts(opts)))
	if err != nil {
		return nil, err
	}
	return &registry, nil
